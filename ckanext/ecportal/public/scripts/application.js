  ...
  setupFileUpload: function() {
    ...
    this.el.find('.fileupload').fileupload({
      ...
      send: function(e, data) {
        self.setMessage(CKAN.Strings.uploadingFile +' <img src="' + CKAN.SITE_URL_NO_LOCALE + '/images/icons/ajaxload-circle.gif" class="spinner" />');
      },
...
CKAN.DataPreview = function ($, my) {
  ...
  my.loadEmbeddedPreview = function(resourceData, reclineState) {
    my.$dialog.html('<h4>Loading ... <img src="' + CKAN.SITE_URL_NO_LOCALE + '/images/icons/ajaxload-circle.gif" class="loading-spinner" /></h4>');
