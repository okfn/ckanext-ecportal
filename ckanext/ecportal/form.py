...
def build_ecportal_form(is_admin=False, 
    ...
    # Extra fields
    builder.add_field(common.GroupSelectField('groups', allow_empty=True, user_editable_groups=user_editable_groups))
    builder.add_field(common.ResourcesField('resources', hidden_label=True, fields_required=set(['url', 'format'])))
    ...
    builder.add_field(fields.GeoCoverageExtraField('geographic_coverage'))
    ...
    builder.add_field(fields.PublisherField('published_by', options=publisher_options))
    builder.add_field(fields.PublisherField('published_via', options=publisher_options))
    ...
    # Options/settings
    builder.set_field_option('name', 'validate', common.package_name_validator)
    ...
    builder.set_field_option('national_statistic', 'validate',
                             fields.national_statistic_validator)
...
def get_ecportal_fieldset(is_admin=False, user_editable_groups=None,
                          publishers=None, **kwargs):
    '''
    Returns the standard fieldset
    '''
    return build_ecportal_form(
