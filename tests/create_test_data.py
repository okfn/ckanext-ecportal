...
class CreateTestData(CkanCreateTestData):
    @classmethod
    def create_ecportal_search_test_data(cls):
...
ecportal_search_items = [
    {
        ...
        'notes':u'''Georg Briel (21 August 1907 - 16 May 1980) was a highly decorated Oberstleutnant
    ...
    },
    {
        ...
        'notes':u'''Samotné jméno Praha vyvolává nejvíce diskuzí, které zřejmě nebudou nikdy uzavřeny.
    ...
    },
    {
        ...
        'notes':u'''Η Κρήτη είναι απομονωμένη από τις υπόλοιπες ηπειρωτικές περιοχές της Ευρώπης,
    ...
    },
    {
        ...
        'notes':u'''El Metro de Barcelona és una xarxa de ferrocarril metropolità soterrat
